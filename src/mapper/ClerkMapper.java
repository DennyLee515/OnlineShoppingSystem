...
public class ClerkMapper extends DataMapper {
    ...
    public boolean insert(DomainObject domainObject) {
        ...
        String insertClerk = "INSERT INTO public.clerk " +
                "(clerk_id,clerk_username,clerk_password,clerk_fname,clerk_lname,start_date,end_date) " +
                "VALUES(?,?,?,?,?,?,?)";
        int result = 0;
        try {
            ...
            preparedStatement.setString(4, clerk.getClerkFistname());
    ...
    public boolean update(DomainObject domainObject) {
        ...
        try {
            ...
            preparedStatement.setString(3, clerk.getClerkFistname());
    ...
    public Clerk findClerkById(DomainObject domainObject) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                clerk1.setClerkFistname(resultSet.getString(4));
